...
export const GetAllowedEmailDomains = async (req : Request, res : Response, next : NextFunction) => {
    ...
    res.status(200).json({AllowedEmailDomains : competitionConfig.AllowedEmailDomains});
}