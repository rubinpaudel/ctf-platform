<template>
    <div class="container- pt-5 h-75 d-flex flex-column align-items-center justify-content-center">
        <div class="btn-group mt-3 mb-3">
            ...
            <ul class="dropdown-menu w-100" aria-labelledby="dropdownMenuButton">
                ...
                <li>
                    <router-link to="#" class="dropdown-item">Solves</router-link>
                </li>
                <li>
        ...
        <div class="container-fluid" v-if="loaded">
            <TeamSolvedComponent v-for="team in teams" :key="team.Id" :team="team"></TeamSolvedComponent>
        </div>
        <LoadingIcon v-else/>
</div>
...
<script lang="ts">
import TeamSolvedComponent from '@/components/TeamSolvedComponent.vue';
...
export default defineComponent ({
    components : {TeamSolvedComponent, LoadingIcon},
    setup () {
        const teams= ref<any[]>([]);
