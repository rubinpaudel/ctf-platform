<template>
    <div class="list-group-item">
        <div class="my-3 text-dark fw-bolder d-flex flex-row justify-content-between">
            <span v-if="!editable" class="text-truncate" style="width:85%" :title="categoryName">
                {{categoryName}}
            </span>
...
export default defineComponent({
    ...
    setup(props, {emit}) {
        ...
        const onSaveClick = () => {
            ...
            onMakeEditable()
            if (name == props.categoryName) return;
